...
#  cp ${top_6_filename}MASK.nii.gz ${top_6_filename}_25MASK.nii.gz;
  cp ${top_6_filename}MASK.nii.gz ${top_6_filename}_20MASK.nii.gz;
...
#  cp ${bottom_6_filename}MASK.nii.gz ${bottom_6_filename}_25MASK.nii.gz;
  cp ${bottom_6_filename}MASK.nii.gz ${bottom_6_filename}_20MASK.nii.gz;
...
#  cp ${top_6_filename}_TOP_MASK.mif ${top_6_filename}_25_TOP_MASK.mif;
  cp ${top_6_filename}_TOP_MASK.mif ${top_6_filename}_20_TOP_MASK.mif;
...
#    -mask ${top_6_filename}_25_TOP_MASK.mif
  dwi2response tournier ${top_6_filename}_20.nii.gz ${top_6_filename}_20.txt \
    -fslgrad ${top_6_filename}_20.bvec ${top_6_filename}_20.bval \
    -mask ${top_6_filename}_20_TOP_MASK.mif
...
#  cp ${top_6_filename}_25.txt ${bottom_6_filename}_25.txt
  cp ${top_6_filename}_20.txt ${bottom_6_filename}_20.txt
}
